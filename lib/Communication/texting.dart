...
class Texting extends StatefulWidget {
  ...
  Texting({Key key, @required this.currentUserId}) : super(key: key);

  @override
  State createState() => TextingState(currentUserId: currentUserId);
}

class TextingState extends State<Texting> {
  TextingState({Key key, @required this.currentUserId});
      ...
      return Container(
        child: FlatButton(
          ...
          onPressed: () {
            ...
            // * IMPORTANTLKAJTLKAJSFDLKJFLKJSDLKFJDSLKFJSLKFJSLKFJDSLKFJKLSFNKJF JKSDFKJLODSM <M <M NJHBNMJH BNM JHBNMJ HBNMH JBNHMJMNHJ GNMHJGMNJHG 
            Navigator.push(
                context,
                MaterialPageRoute(
